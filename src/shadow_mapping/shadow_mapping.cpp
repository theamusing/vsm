...
void renderScene(Shader &shader,Model& mymodel);
void renderCube();
void renderQuad();
void genTexture(GLuint& texture, GLuint& fbo,unsigned int num);
// settings
...
int main()
{
    ...
    //string path = "D:/Users/nbyqy/source/repos/vsm/src/shadow_mapping";
    ...
    // load models
    //--------------
    Model mymodel(FileSystem::getPath("models/dinosaur.obj").c_str());


    // load textures
    // -------------
    unsigned int woodTexture = loadTexture(FileSystem::getPath("textures/wood.png").c_str());

    // configure depth map FBO
    // -----------------------
    unsigned int depthMapFBO,depthMap;
    genTexture(depthMap, depthMapFBO,0);
    
    unsigned int blurfbo, blurmap;
    genTexture(blurmap, blurfbo,0);
    ...
    glDrawBuffer(depthMapFBO);
    glReadBuffer(depthMapFBO);
